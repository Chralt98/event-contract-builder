...
candidate-question draft, workflow follow-ups, or unselected alternatives. After final approval, offer to show the complete specification in chat. Call `get_approved_forecast_specification` only when the user chooses to see it.
