...
1. Use `draft-display-question` to turn a sufficiently specific future event into selectable display-question units, then call `submit_drafted_questions` and present its returned Markdown verbatim.
...
- `submit_drafted_questions` validates and renders selectable binary, scalar, and categorical question units.
