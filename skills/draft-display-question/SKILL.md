...
The workflow expects a free-form event description and produces one or more concise questions organized into selectable binary, scalar, categorical, or template forecast specification units.
