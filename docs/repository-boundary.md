...
| Seven skills and references                                                          | Tool handlers and rendering                                                       |
...
`get_approved_forecast_specification` tool. The public Markdown instructions
also define the consistent `---`
